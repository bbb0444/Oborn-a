...
// 		GlobalSignals.AddListener("Shoot", this, nameof(_on_shoot));
...
// 		Vector3 collisionPoint = GetCollisionPtAndObj(camera);
...
// 	{
// 		Vector2 spray = new Vector2(0, 0);
// 		var viewport = GetViewport().Size;
// 		Vector3 rayOrigin = camera.ProjectRayOrigin(viewport / 2);
// 		Vector3 rayEnd = (rayOrigin + camera.ProjectRayNormal((viewport / 2) + new Vector2i(spray)) * Range);
